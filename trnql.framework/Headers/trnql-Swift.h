...
/// A container class which holds the open hours for a place as separate components.
SWIFT_CLASS("_TtC5trnql9OpenHours")
@interface OpenHours : NSObject <NSCoding>
...
/// Get the status of and current information about trnql components including API Key, Background Execution, SmartActivity, SmartLocation, SmartPlaces, and SmartWeather.
- (void)getStatus;
...
///
/// \param location A <code>PlacesEntry
/// </code> object containing the places data.
///
